...
$$
\mathcal{L} = \alpha \cdot \mathcal{L}_{\text{CE}}\big(y, p^{(S)}_{T=1}\big) 
+ (1 - \alpha) \cdot \mathcal{L}_{\text{KD}}.
$$

$\mathcal{L} = \alpha \cdot \mathcal{L}_ {\text{CE}}\big(y, p^{(S)}_{T=1}\big) (1 - \alpha) \cdot \mathcal{L}_{\text{KD}}.$
